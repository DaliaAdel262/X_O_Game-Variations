...
PyramidTicTacToe_Board::PyramidTicTacToe_Board()
{
    n_moves = 0;
    n_cols = 5;
    n_rows = 3;
...
bool PyramidTicTacToe_Board::update_board(int x, int y, char mark)
{
    if (n_moves == 9)
    {
        return false;
...
void PyramidTicTacToe_Board::display_board()
{
    cout << "======================\n";
    for (size_t i = 0; i < n_rows; i++)
    {
...
bool PyramidTicTacToe_Board::is_winner()
{
...
bool PyramidTicTacToe_Board::is_draw()
{
    if (n_moves == 9)
    {
        return true;
...
bool PyramidTicTacToe_Board::game_is_over()
{
    if (n_moves == 9)
    {
        return true;
...
bool PyramidTicTacToe_Board::moves()
{
    return false;
}

string PyramidTicTacToe_Board::Is_Winner() {
    return " ";
}